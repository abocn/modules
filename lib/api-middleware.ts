...
export function withAuth(options: AuthOptions = {}) {
  return function (
    handler: (request: AuthenticatedRequest, context: AuthContext) => Promise<NextResponse>,
  ) {
...
export function withOptionalAuth(
  options: Omit<AuthOptions, 'requireAuth' | 'requireAdmin' | 'requireScope'> = {},
) {
  return withAuth({
    ...options,
    requireAuth: false,
...
export function withApiKeyAuth(
  scope: 'read' | 'write',
  options: Omit<AuthOptions, 'requireAuth' | 'requireScope'> = {},
) {
  return withAuth({
    ...options,
    requireAuth: true,
