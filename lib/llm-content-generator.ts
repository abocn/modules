...
export function getSidebarNavigation() {
  const browseItems: NavigationItem[] = [
    { id: 'home', label: 'Home', path: '/', description: 'Browse all modules' },
    {
      ...
      path: '/search',
      description: 'Find specific modules',
    },
    {
      id: 'featured',
      label: 'Featured',
      path: '/featured',
      description: "Editor's choice modules",
    },
    {
      id: 'recent',
      label: 'Recently Updated',
      path: '/recent',
      description: 'Latest module updates',
    },
    {
      id: 'recommended',
      label: 'Recommended',
      path: '/recommended',
      description: 'Community recommended modules',
    },
  ];
  ...
  const accountItems: NavigationItem[] = [
    {
      ...
      label: 'Submit Module',
      path: '/submit',
      description: 'Submit your own module',
    },
    {
      id: 'my-submissions',
      label: 'My Submissions',
      path: '/my-submissions',
      description: 'View your submitted modules',
    },
...
export async function getAPIEndpoints(): Promise<APIEndpoint[]> {
  ...
  const publicEndpoints: APIEndpoint[] = [
    ...
    {
      method: 'GET',
      path: '/api/modules/my-submissions',
    ...
    {
      method: 'POST',
      path: '/api/modules/[id]/helpful-votes',
      description: 'Mark a module review as helpful',
      auth: true,
    },
  ];
  ...
  const settingsEndpoints: APIEndpoint[] = [
    ...
    {
      method: 'POST',
      path: '/api/settings/github-pat/validate',
      description: 'Validate GitHub PAT',
      auth: true,
    },
  ];
  ...
  const ratingsEndpoints: APIEndpoint[] = [
    {
      method: 'POST',
      path: '/api/ratings/[id]/helpful',
      description: 'Mark rating as helpful',
      auth: true,
    },
    {
      method: 'POST',
      path: '/api/ratings/[id]/replies',
  ...
  const repliesEndpoints: APIEndpoint[] = [
    {
      method: 'POST',
      path: '/api/replies/[id]/helpful',
      description: 'Mark reply as helpful',
      auth: true,
    },
  ];
...
export function generateAPISection(endpoints: APIEndpoint[], includeAdminSection: boolean = false) {
  ...
  const authEndpoints = endpoints.filter(
    (e) => e.auth && !e.path.includes('admin') && !e.path.includes('auth'),
  );
