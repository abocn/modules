...
export const ModulesQueryParamsSchema = z.object({
  ...
  filter: z
    .enum(['featured', 'recommended', 'recent'])
    .optional()
    .describe('Pre-defined filter type'),
});
...
export const CreateRatingBodySchema = z.object({
  ...
  comment: z
    ...
    .max(1000)
    .optional()
    .describe('Optional review comment (max 1000 characters)'),
...
export const SearchQueryParamsSchema = z.object({
  ...
  category: z.string().optional().describe('Filter by category'),
  sort: z
    .enum(['relevance', 'downloads', 'rating', 'updated', 'name'])
    .default('relevance')
    .describe('Sort order'),
...
export const createApiKeySchema = z.object({
  ...
  expiresIn: z
    .enum(['30days', '90days', '1year', 'never'])
    .default('90days')
...
export const UpdateModuleBodySchema = z.object({
  ...
  release: z
    ...
    .optional()
    .describe('New release information'),
});
