...
export const moduleSubmissionSchema = z
  .object({
    name: z
      .string()
      .trim()
...
export const releaseSchema = z.object({
  version: z.string().trim().transform(normalizeVersion),
  downloadUrl: z
    .string()
    .trim()
  ...
  changelog: z.string().trim().max(5000, 'Changelog must be at most 5000 characters').optional(),
...
export const clientModuleSchema = z
  .object({
