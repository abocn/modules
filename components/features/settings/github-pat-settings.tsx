    ...
    <div className="container max-w-4xl py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up your GitHub PAT to enable automatic release syncing for your modules. This allows
            us to fetch releases from your GitHub repositories with higher rate limits.
          </CardDescription>
        </CardHeader>
          ...
          {hasToken ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={removeToken} disabled={isLoading} variant="destructive" size="sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <span className="font-bold">
                    We recommend creating a PAT with minimal permissions because no scopes are
              ...
              <Button type="submit" disabled={isLoading || isValidating}>
                {isValidating ? 'Validating token...' : isLoading ? 'Saving...' : 'Save GitHub PAT'}
              </Button>
            </form>
          )}
        </CardContent>
