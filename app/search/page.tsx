...
export const metadata: Metadata = {
  ...
  description:
    'Search and filter through tons of Magisk and KernelSU modules. Find exactly what you need with advanced search options.',
  keywords: [
    'search magisk modules',
    'find magisk modules',
    'best magisk modules',
    'kernelsu modules',
    'magisk module search',
  ],
  openGraph: {
